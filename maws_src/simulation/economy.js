...
export const BALANCE_V2 = deepFreeze({
  ...
  actions: {
    ...
    idle_blank: { time: 15, sp: 0, gain: { calm: 1, fatigue: -1 } },
    read_notes: { time: 20, sp: 0, gain: { jud: 1, calm: 1 } },
    scroll_short_video: { time: 15, sp: 0, gain: { morale: 1, heat: 1, calm: -1 } },
    message_friend: { time: 20, sp: 0, gain: { morale: 1, rel_fatty: 1 } },
    simple_stretch: { time: 20, sp: 0, gain: { fatigue: -3, calm: 1 } },
